...
<div class="mobile-menu md:hidden" style="border: 0; width: 100vw">
    <div class="mobile-menu-bar" style="background: #3f4366; box-shadow: 0px 0px 10px #121420; height: 60px;">
        <a href="" class="flex mr-auto" onclick="openMenuM()">
            <img alt="IOX Token" class="w-6" src="../dist/imgs/avarice_logo_1.png" style="width: 34vw;">
        </a>
        ...
        <div class="top-bar-boxed flex items-center" style="margin-right: -5px;">
            <div style="background: #040417;/* box-shadow: 2px 2px 8px #202639a1; */height: 38px;border-radius: 6px;padding: 2px 0px 0px 10px;border: 3px solid #42527178;color: #c5d6f3;font-size: 17px;font-weight: 500;margin-right: 4px;"><span class="day-end-in-mb" style="padding-right: 10px; word-spacing: -3px;"> -- : -- : --</span></div>
            <div class="switcher-chains" onclick="switchChains()" style="background: rgba(211, 50, 91, 0.2);box-shadow: rgba(32, 38, 57, 0.44) 2px 2px 8px;height: 34px;border-radius: 6px;/* padding: 2px 0px 0px 10px; */border: 3px solid rgba(220, 63, 83, 0.21);color: rgb(197, 214, 243);font-size: 18px;font-weight: 500;margin-right: 3px;float: inherit;margin-top: 2px;cursor: pointer;"><span class="day-end-n-m" style="/* padding-right: 10px; */">IOX</span></div>
        </div>
        ...
        <ul class="border-t border-theme-24 py-7">
            ...
            border-bottom-width: 2px;" onclick="location.href='lending.html';">
                <a href="lending.html" class="menu">
                    <div class="menu__icon"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-server"><rect x="2" y="2" width="20" height="8" rx="2" ry="2"></rect><rect x="2" y="14" width="20" height="8" rx="2" ry="2"></rect><line x1="6" y1="6" x2="6.01" y2="6"></line><line x1="6" y1="18" x2="6.01" y2="18"></line></svg> </div>
                    <div class="menu__title">loan&lend</div>
                </a>
            </li>
...
<div class="border-b hd-nm border-theme-24 -mt-10 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 pt-3 md:pt-0 mb-10" style="border: none; background: #262935; padding:0px">
    ...
    background: linear-gradient(to right, #515874 0%, #363945 100%) !important;">
        ...
        <a href="" class="-intro-x hidden md:flex">
           <img href="../dist/avarice_logo.png" alt="IOX Tokens" class="w-6" src="./dist/imgs/avarice_logo_1.png" style="width: 9rem;filter: drop-shadow(0px 0px 3px #120f275e);; width: 181px;
    height: 40px;">            <!--<span class="text-white text-lg ml-3" style="padding-top: 0.2rem;font-size: 28px;padding-left: 5px;font-weight: 500;color: #c5d6f3;">IOX</span> -->
        </a>
        <!-- END: Logo -->
       <div style="
...
<div class="switcher-chains" onclick="switchChains()" style="background: #7845ac2b;box-shadow: 2px 2px 8px #20263970;height: 34px;border-radius: 6px;padding: 2px 0px 0px 10px;border: 3px solid #623e84ab;color: #c5d6f3;font-size: 18px;font-weight: 500;margin-right: 3px;float: inherit;margin-top: 2px;cursor: pointer;"><span class="day-end-n" style="padding-right: 10px;">To BIOX</span></div>
...
<div style="height: 38px;padding: 2px 0px 0px 10px;font-size: 18px;font-weight: 500;padding-top: 7px;padding-left: 40px;">
   ...
   <a class="t-pp pg_tt_lending" href="lending.html">Lend&Loan</a>

   <a class="t-pp pg_tt_buyandsell" href="buyandsell.html">Buy&Sell</a>

   <a class="t-pp pg_tt_faq" onclick="openfaq()">FAQ</span>
