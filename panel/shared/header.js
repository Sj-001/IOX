...
<div class="mobile-menu md:hidden" style="border: 0; width: 100vw">
    <div class="mobile-menu-bar" style="background: #3f4366; box-shadow: 0px 0px 10px #121420; height: 60px;">
        ...
        <div class="top-bar-boxed flex items-center" style="margin-right: -5px;">
            <div style="background: #040417;/* box-shadow: 2px 2px 8px #202639a1; */height: 38px;border-radius: 6px;padding: 2px 0px 0px 10px;border: 3px solid #42527178;color: #c5d6f3;font-size: 17px;font-weight: 500;margin-right: 4px;"><span class="day-end-in-mb" style="padding-right: 10px; word-spacing: -3px;">Day Ends In: -- : -- : --</span></div>
            <div class="switcher-chains" onclick="switchChains()" style="background: #7845ac2b;box-shadow: 2px 2px 8px #20263970;height: 34px;border-radius: 6px;padding: 0px;border: 3px solid #623e84ab;color: #c5d6f3;font-size: 18px;font-weight: 500;margin-right: 3px;float: inherit;margin-top: 2px;cursor: pointer;"><span class="day-end-n" style="padding-right: 0px;">BIOX</span></div>
        </div>
